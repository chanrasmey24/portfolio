      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-300 leading-relaxed mb-4 max-w-md">
                I’m a final-year Management Information Systems student focused on backend and full-stack development. I build real-world systems including e-commerce platforms, REST APIs, and data dashboards using Laravel, Spring Boot, and Python.
            </p>
